...
void earth() {
  ...
  auto earth_serface = make_shared<lambertian>(earth_texture);
  auto globe = make_shared<sphere>(point3(0, 0, 0), 2, earth_serface);
...
void cornell_box() {
  ...
  box1 = make_shared<rotate_y>(box2, -18);
  box1 = make_shared<translate>(box2, vec3(130, 0, 65));
  world.add(box2);
...
void cornell_smoke() {
  ...
  world.add(make_shared<quad>(point3(0, 0, 0), vec3(0, 555, 0), vec3(0, 0, 555),
                              red));
  world.add(make_shared<quad>(point3(133, 554, 127), vec3(330, 0, 0),
                              vec3(0, 0, 305), light));
